...
@Component({
  selector: 'app-agenda-diaria-dentista-mobile',
  templateUrl: './agenda-diaria-dentista-mobile.component.html',
  styleUrls: ['./agenda-diaria-dentista-mobile.component.css']
})
export class AgendaDiariaDentistaMobileComponent implements OnInit {
  ...
  selecionarAgendaDiariaDentista(): void {
    this.router.navigate(['agenda-mobile/' + this.dia + '/' + this.dentistaId]);
    this.listarTodos();
    this.listarDentistas();
    this.listarDentistaSelecionado();
    this.listarDatas();
